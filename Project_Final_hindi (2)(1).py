...
def call(I):
    ...
    while(cap.isOpened()): 
      ...
      if ret == True: 
        ...
        cv2.moveWindow('Sukriti',530,140)
        cv2.imshow('Sukriti', frame) 
...
def quit_func():
    global windows50
    tkinter.messagebox.showinfo("Quit",f"You have chosen to exit the game\nYour final score is {score}")
    windows50.destroy()
...
def about_page():
    audio_nb.select(5) #opening about page tab
...
def homepage():
    ...
    homepage_pic1 = Image.open('D:/Reliance School/Computer Project/images/boy.png')

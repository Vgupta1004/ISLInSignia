# -*- coding: utf-8 -*-
"""
Created on Thu Mar 11 16:29:05 2021
...
def Submit():
    ...
    if len(text)>0:
            ...
            for i in words:
                if i in verbs:
                    ...
                    if i in list:
                        ...
                        for j in list:
                            if i in PyDictionary().synonym(j):
                                list1.append(j)
                                text_mainwords.insert('insert','-->'+i+'\n')
                            else:
                                for k in i:
        ...
        frame5=tk.Frame(Sign_tab,bg='#FFBC8B')
...
def sign_generator():
    ...
    #_______________________________________________________
    #window heading
    frame1=tk.Frame(Sign_tab,bg='#FFBC8B')
    ...
    #_______________________________________________________
    #displaying menu bar
    frame2=tk.Frame(Sign_tab,bg='#5B524A')
    ...
    English_btn=tk.Button(frame2,text='Sign lanuguage generator',bg='#5B524A',fg='#F29062',padx=10,borderwidth=0,font=('Cambria',14),command=sign_generator)
    ...
    global english_pic3
    global frame3
    frame3=tk.Frame(Sign_tab,bg='#FFBC8B')
    ...
    global frame4
    global sentences
    frame4=tk.Frame(Sign_tab,bg='#FFBC8B')
...
#designing sign_generator ends here
#_______________________________________________________
#_______________________________________________________
...
Sign_tab = tk.Frame(audio_nb,width=1250,height=750,bg='#FFBC8B')
About_tab = tk.Frame(audio_nb,width=1250,height=750,bg='#FFBC8B')


audio_nb.add (Homepage_tab , text="Homepage")
audio_nb.add (Sign_tab , text="Sign lanuguage generator")

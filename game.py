...
global title_lb
global title2_lb
title_lb = tk.Label(window1, text = "It's Game Time", font=('Gabriola',68,'bold'),bg='#FFBC8B')
...
global score1_lb
global total1_lb
score1_lb = tk.Label(window1, text = "Score:", font=('Cambria',35),bg='#FFBC8B')
total1_lb = tk.Label(window1, text = "Total Questions:", font=('Cambria',35),bg='#FFBC8B')
score1_lb.place(x = 900, y = 125)
total1_lb.place(x = 900, y = 175)
global score2_lb
global total2_lb
score2_lb = tk.Label(window1, text = score, font=('Cambria',35),bg='#FFBC8B')
total2_lb = tk.Label(window1, text = total, font=('Cambria',35),bg='#FFBC8B')
...
global video
video = tk.Label(window1,bg='#FFBC8B')
...
def displayQ():
    global playVid_btn
    playVid_btn = tk.Button(window1, text = "Play the video", command = playVid, font=('Cambria',40),bg='#F29062')
...
def accept_ans():
    ...
    ansCorrect_lb = tk.Label(window1, text = "Correct Answer!",font=('Cambria',25),bg='#FFBC8B')
    ansWrong_lb = tk.Label(window1, text = ('Incorrect Answer\nCorrect answer is : ',Q), font=('Cambria',14),bg='#FFBC8B')
    #answerRight_lb = tk.Label(window1, text = Q, font=('Cambria',14),bg='#FFBC8B')
    if answer==Q:
        ansCorrect_lb.place(x = 975, y = 400, width = 300)
        score+=1
    else:   
        ansWrong_lb.place(x = 975, y = 400, width = 300)
        #answerRight_lb.place(x = 1150, y=450)
    score2_lb = tk.Label(window1, text = score, font=('Cambria',35),bg='#FFBC8B')
    total2_lb = tk.Label(window1, text = total, font=('Cambria',35),bg='#FFBC8B')
    score2_lb.place(x = 1250, y = 125)
    total2_lb.place(x = 1250, y = 175)
...
def enter_ans():
    ...
    global Q
    global answer_ent
    answer_lb = tk.Label(window1, text = "Enter your Answer",font=('Cambria',14),bg='#FFBC8B')
    answer_lb.place(x = 975, y = 300)
    answer_ent = tk.Entry(window1, width = 30,font=('Cambria',14))
    answer_ent.place(x=975, y=360)
    answer_btn = tk.Button(window1, text = "Enter", font=('Cambria',14), command=accept_ans,bg='#F29062')
    answer_btn.place(x = 1250, y = 360)
...
def next_func():
    ...
    video.destroy()
    clear_lb = tk.Label(window1, font=('Cambria',30),bg='#FFBC8B')
...
def display_next():
    global next_btn
    next_btn = tk.Button(window1, text = "Next Question", font=('Cambria',16), command=next_func,bg='#F29062')
...
def playAgain():
    ...
    playAgain_btn = tk.Button(window1, text = "Play Again", command = playAgain_func, font=('Cambria',40),bg='#F29062')
...
def display_quit():
    global quit_btn
    quit_btn = tk.Button(window1, text = "Quit", command = quit_func, font=('Cambria',16),bg='#F29062')
